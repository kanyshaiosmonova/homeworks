...
void main() {
  Car car = Car(150, 'красный', 'BMW X5', 3500000.0);
  car.printCarInfo();
}
...
class Reader {
  ...
  Reader(this.name, this.libraryCardNumber, this.faculty, this.dateOfBirth, this.phone);
  ...
  void takeBookByObject(List<Book> books) {
    var titles = books.map((book) => '${book.title} (${book.author})').join(', ');
